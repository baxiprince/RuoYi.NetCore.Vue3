<template>
  <div class="app-container">
    <el-row>
      ...
      <el-col :span="24" class="card-box">
        <el-card>
          <template #header><CoffeeCup style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;"> .NET CLR信息</span></template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;table-layout:fixed;">
              <tbody>
                <tr>
                  <td class="el-table__cell is-leaf"><div class="cell">.Net名称</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell" v-if="server.clr">{{ server.clr.name }}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell">.Net版本</div></td>

...
public class AuthorizationMiddlewareResultHandler : IAuthorizationMiddlewareResultHandler
{
    ...
    PolicyAuthorizationResult authorizeResult)
  {
    ...
    var loginUser = tokenService.GetLoginUser(context.Request);
    if (loginUser != null)
    {
      ...
      {
        // Unauthorized
        var result = AjaxResult.Error(StatusCodes.Status403Forbidden, "403 Forbidden");
    ...
    else
    {
      ...
      // Unauthorized
      var result = AjaxResult.Error(StatusCodes.Status401Unauthorized, "401 Unauthorized");
      await context.Response.WriteAsJsonAsync(result, App.GetOptions<JsonOptions>()?.JsonSerializerOptions);
    }
  }
  ...
  private static bool HasPermi(string permission)
  {
    ...
    if (loginUser == null || loginUser.Permissions.IsEmpty()) return false;

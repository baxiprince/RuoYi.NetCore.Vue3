...
public static class SqlSugarServiceCollectionExtensions
{
  ...
  {
    return services.AddSqlSugarClient(new[] { config }, buildAction);
  }
  ...
  /// <param name="buildAction"></param>
  /// <returns></returns>
  public static IServiceCollection AddSqlSugarClient(this IServiceCollection services, ConnectionConfig[] configs,
    Action<ISqlSugarClient> buildAction = default)
  {
    // 注册 SqlSugar 客户端

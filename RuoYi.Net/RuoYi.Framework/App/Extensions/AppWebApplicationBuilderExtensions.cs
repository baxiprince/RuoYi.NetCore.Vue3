...
public static class AppWebApplicationBuilderExtensions
{
  ...
  public static WebApplicationBuilder Inject(this WebApplicationBuilder webApplicationBuilder,
    Action<WebApplicationBuilder, InjectOptions> configure = default)
  {
    // 载入服务配置选项
  ...
  /// </returns>
  public static WebApplicationBuilder AddComponent<TComponent, TComponentOptions>(
    this WebApplicationBuilder webApplicationBuilder, TComponentOptions options = default)
    where TComponent : class, IServiceComponent, new()
  {
  ...
  ///   <see cref="WebApplicationBuilder" />
  /// </returns>
  public static WebApplicationBuilder AddWebComponent<TComponent>(this WebApplicationBuilder webApplicationBuilder,
    object options = default)
  ...
  ///   <see cref="WebApplicationBuilder" />
  /// </returns>
  public static WebApplicationBuilder AddWebComponent<TComponent, TComponentOptions>(
    this WebApplicationBuilder webApplicationBuilder, TComponentOptions options = default)
    where TComponent : class, IWebComponent, new()
  {
  ...
  ///   <see cref="WebApplicationBuilder" />
  /// </returns>
  public static WebApplicationBuilder AddWebComponent(this WebApplicationBuilder webApplicationBuilder, Type componentType,
    object options = default)
  {
    // 创建组件依赖链
  ...
  {
    if (!string.IsNullOrWhiteSpace(App.Settings.VirtualPath)) return app.Map(App.Settings.VirtualPath, configuration);

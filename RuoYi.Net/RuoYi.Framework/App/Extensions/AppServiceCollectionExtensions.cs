...
public static class AppServiceCollectionExtensions
{
  ...
  public static IServiceCollection AddInjectWithUnifyResult(this IServiceCollection services,
    Action<AddInjectOptions> configure = null)
  {
  ...
  public static IServiceCollection AddAppHostedService(this IServiceCollection services)
  {
    ...
    var backgroundServiceTypes =
      App.EffectiveTypes.Where(u => typeof(IHostedService).IsAssignableFrom(u) && u.Name != "GenericWebHostService");
  ...
  internal static IServiceCollection AddStartups(this IServiceCollection services)
  {
    ...
    foreach (var type in startups)
    {
      ...
      // 自动安装属性调用
      foreach (var method in serviceMethods) method.Invoke(startup, new[] { services });
    }

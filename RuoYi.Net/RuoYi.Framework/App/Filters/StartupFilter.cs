...
public class StartupFilter : IStartupFilter
{
    ...
    return app =>
    {
      ...
      app.Use(async (context, next) =>
      {
        ...
        else
        {
          ...
          // 输出框架版本
          context.Response.Headers[nameof(Framework)] = version;
  ...
  private static void UseStartups(IEnumerable<AppStartup> startups, IApplicationBuilder app)
  {
    ...
    foreach (var startup in startups)
    {
      ...
      // 自动安装属性调用
      foreach (var method in configureMethods) method.Invoke(startup, ResolveMethodParameterInstances(app, method));
    }
